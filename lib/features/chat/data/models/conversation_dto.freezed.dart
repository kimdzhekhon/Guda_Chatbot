...
mixin _$ConversationDto {
 ...
 String get id; String get title;@JsonKey(name: 'topic_code') String get topicCode;@JsonKey(name: 'user_id') String get userId;@JsonKey(name: 'last_message_preview') String? get lastMessagePreview;@JsonKey(name: 'message_count') int get messageCount;@JsonKey(name: 'created_at') String? get createdAt;@JsonKey(name: 'last_message_at') String? get lastMessageAt;
...
@override
String toString() {
  return 'ConversationDto(id: $id, title: $title, topicCode: $topicCode, userId: $userId, lastMessagePreview: $lastMessagePreview, messageCount: $messageCount, createdAt: $createdAt, lastMessageAt: $lastMessageAt)';
}
...
@useResult
$Res call({
 String id, String title,@JsonKey(name: 'topic_code') String topicCode,@JsonKey(name: 'user_id') String userId,@JsonKey(name: 'last_message_preview') String? lastMessagePreview,@JsonKey(name: 'message_count') int messageCount,@JsonKey(name: 'created_at') String? createdAt,@JsonKey(name: 'last_message_at') String? lastMessageAt
});
...
/// Create a copy of ConversationDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? topicCode = null,Object? userId = null,Object? lastMessagePreview = freezed,Object? messageCount = null,Object? createdAt = freezed,Object? lastMessageAt = freezed,}) {
...
class _ConversationDto extends ConversationDto {
  const _ConversationDto({required this.id, required this.title, @JsonKey(name: 'topic_code') required this.topicCode, @JsonKey(name: 'user_id') required this.userId, @JsonKey(name: 'last_message_preview') this.lastMessagePreview, @JsonKey(name: 'message_count') this.messageCount = 0, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'last_message_at') this.lastMessageAt}): super._();
...
/// Create a copy of ConversationDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? topicCode = null,Object? userId = null,Object? lastMessagePreview = freezed,Object? messageCount = null,Object? createdAt = freezed,Object? lastMessageAt = freezed,}) {
